...
local pretrained_ckpt_path = "LinWeizheDragon/PreFLMR_ViT-L";
local reranker_pretrained_ckpt_path = "LinWeizheDragon/PreFLMR_ViT-L";
...
local index_files = {
  ...
  "embedding_path": "",
  "static_results": [
    "/home/fz288/rds/hpc-work/PreFLMR/search_index/OKVQA/PreFLMR-L/_test_OKVQADatasetForDPR.test_predictions_rank_0.pkl",
  ],
};
