    ...
    pipeline: {
      transforms: {
        'process:ConcatenateDatasets': {
          ...
          cache: true,
          setup_kwargs: {
            negative_names: ["wit_passages", "cc_passages", "llava_passages", "msmarco_passages", "infoseek_passages", "oven_passages", "kvqa_passages", 'okvqa_passages', 'evqa_passages'],
            concat_splits: {
              'train': [false, false, false, false, false, false, false, false, true],
              'valid': [true, false, false, false, true, false, false, true, true],
            },
        ...
        'process:ConcatenatePassageDatasets': {
          ...
          cache: true,
          setup_kwargs: {
            names: ["wit_passages", "cc_passages", "llava_passages", "msmarco_passages", "infoseek_passages", "oven_passages", "kvqa_passages", 'okvqa_passages', 'evqa_passages'],
            concat_splits: {
              'passages': [false, false, false, false, false, false, false, true, true],
              'filtered_passages': [true, false, false, false, true, false, false, true, true],
            },
          },
        },
