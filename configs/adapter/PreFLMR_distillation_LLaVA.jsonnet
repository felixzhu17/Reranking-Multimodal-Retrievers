...
local pretrained_ckpt_path = "/root/rds/data/models/LinWeizheDragon--PreFLMR_ViT-L";
local image_processor_name = "/root/rds/data/models/llava-hf--llava-v1.6-vicuna-7b-hf";

local tokenizer_config = {
  "tokenizer": {
    "TokenizerClass": "AutoTokenizer",
    "TokenizerModelVersion": "/root/rds/data/models/llava-hf--llava-v1.6-vicuna-7b-hf",
    "SPECIAL_TOKENS":{
...
local image_processor_config = {
  "vit_image_processor": {
    "ImageProcessorClass": "LlavaNextImageProcessor",
    ...
    'output:PrepareDataloaders': {
      ...
      setup_kwargs: {
        ...
        datasets_config: {
          train: [
            {
              dataset_type: 'CommonDatasetForDistillation',
              split: 'train',
...

{
    ...
    model_config: {
        "base_model": "FLMR",
        "ConfigClass": "FLMRAdapterConfig",
        "ModelClass": "FLMRModelWithAdapter",
        "QueryEncoderModelClass": "LlavaNextForConditionalGeneration",
        "QueryEncoderConfigClass": "LlavaNextConfig",
        "QueryEncoderModelVersion": "/root/rds/data/models/llava-hf--llava-v1.6-vicuna-7b-hf",
        "ContextEncoderModelClass": "FLMRModelForRetrieval",
        "ContextEncoderConfigClass": "FLMRConfig",
        "ContextEncoderModelVersion": pretrained_ckpt_path,
        "pretrained": 1,
        "modules": [
        ...
        "input_modules": {
            "module_list":[
                {"type": "VisionInput",  "option": "from_file", "resize": 336},
            ...
            "postprocess_module_list": [
                ...
                {"type": "PostProcessLLaVAQuestionInputTokenization", "option": "default"},
            ],
        },
