...
options="--experiment_name \"InfoSeek(all)_VisualColBERT(large_from_scratch)_with_text_based_vision_more_docs_4GPU\" \
    --config \"configs/infoseek/ColBERT_vision_with_ROI.jsonnet\" \
    --reset --override \
    --mode train \
    --opts meta.EXPERIMENT_FOLDER=\"/home/wl356/big_picture_rds/wl356/experiments_new\" \
             meta.default_cache_dir=\"/home/wl356/big_picture_rds/wl356/program_cache\" \
             model_config.EncoderModelVersion=\"bert-large-uncased\" \
             ...
             valid.batch_size=16 \
             train.trainer_paras.accumulate_grad_batches=8 \
             ...
             train.load_model_path=\"/home/wl356/cvnlp_rds/wl356/projects/KBVQA/experiments/WIT_DPR_ViT_ColBERT/train/saved_models/model_step_4000.ckpt\""
