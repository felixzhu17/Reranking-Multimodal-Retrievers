...
options="--experiment_name \"OKVQA_RAG_VisualColBERT_BLIP2_T5xl_with_pretrained_ViT(WIT)_with_text_based_vision_K=5_LR1e-4_K_train=5\" \
    --config \"configs/rag/okvqa/RAG_colbert_BLIP2_with_vision_no_ROI.jsonnet\" \
    --accelerator auto --devices auto --strategy ddp \
    --reset --override \
    --num_sanity_val_steps 1 \
    --precision bf16 \
    --mode train \
    --opts train.trainer_paras.max_epochs=10000000 \
             train.batch_size=2 \
