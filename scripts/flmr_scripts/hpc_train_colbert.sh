...
options="--experiment_name \"OKVQA_WITCorpus(v2)_ColBERT_with_text_based_vision_unimodal_docs\" \
    --config \"configs/okvqa/wit/ColBERT.jsonnet\" \
    ...
    --opts train.trainer_paras.max_epochs=10000 \
             ...
             model_config.multimodal_docs=0 \
