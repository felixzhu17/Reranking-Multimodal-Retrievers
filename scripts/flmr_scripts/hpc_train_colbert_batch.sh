...
options="--experiment_name \"OKVQA_VisualColBERT_with_pretrained_ViT(WIT)_${EXPERIMENT_NAME}ROI_with_text_based_vision\" \
    --config \"configs/okvqa/ColBERT_vision_with_ROI.jsonnet\" \
    ...
    --opts train.trainer_paras.max_epochs=10000 \
             ...
             model_config.num_ROIs=${EXPERIMENT_NAME} \
