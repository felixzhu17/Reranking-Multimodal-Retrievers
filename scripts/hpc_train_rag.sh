...
options="--experiment_name \"OKVQA_VisualColBERT(10ROI_with_text_based_vision)_RAG(Flan-t5-large_with_text_based_vision)_lr=6e-5_linear_bz=2_grad_accum=16_K=5_IgnoreRetrieverConfidence\" \
    --config \"configs/rag/okvqa/RAG_colbert_with_vision.jsonnet\" \
    --reset --override \
    --mode train \
