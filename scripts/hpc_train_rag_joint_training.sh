...
options="--experiment_name \"OKVQA_VisualColBERT(10ROI_with_text_based_vision)_RAG(Flan-t5-large_with_text_based_vision)_epoch=1000_lr=4e-5_retriever_lr=1e-5_bz=2_grad_accum=16_K=5_RAGELoss(Approach5)=1\" \
    ...
    --opts train.trainer_paras.max_epochs=1000 \
             ...
             train.optimizer_config.optimizer_params.lr=0.00004 \
