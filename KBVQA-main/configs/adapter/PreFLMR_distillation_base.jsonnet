...
local tokenizer_config = {
  "tokenizer": {
    ...
    "TokenizerModelVersion": "/root/rds/data/models/Qwen--Qwen-VL-Chat",
    "SPECIAL_TOKENS":{
...

{
    ...
    model_config: {
        ...
        "QueryEncoderModelClass": "AutoModelForCausalLM",
        "QueryEncoderConfigClass": "AutoConfig",
        "QueryEncoderModelVersion": "/root/rds/data/models/Qwen--Qwen-VL-Chat",
        ...
        "input_modules": {
            "module_list":[
                {"type": "VisionInput",  "option": "path_only"},
            ...
            "postprocess_module_list": [
                ...
                {"type": "PostProcessQWenQuestionInputTokenization", "option": "default"},
            ],
        },
