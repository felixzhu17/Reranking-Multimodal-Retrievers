...
local index_files = {
  "index_passages_path": "$OKVQA_VisualDPR_with_pretrained_ViT(WIT)_ColBERT_mapping_trainable_ViT_frozen_5ROI_with_text_based_vision/test/generate_index/step_5016/dataset/",
  "index_path": "$OKVQA_VisualDPR_with_pretrained_ViT(WIT)_ColBERT_mapping_trainable_ViT_frozen_5ROI_with_text_based_vision/test/generate_index/step_5016/dataset_hnsw_index.faiss",
};
local data_loader = {
  transforms: {
...

{
    ...
    model_config: {
        ...
        "QueryEncoderModelClass": "VisualDPRForRAG", // question encoder
        "QueryEncoderModelVersion": "$OKVQA_VisualDPR_with_pretrained_ViT(WIT)_ColBERT_mapping_trainable_ViT_frozen_5ROI_with_text_based_vision/train/saved_models/step_5016/query_encoder",
        "QueryEncoderConfigClass": "DPRConfig", // question encoder
        "QueryEncoderVisionMappingPath": "$OKVQA_VisualDPR_with_pretrained_ViT(WIT)_ColBERT_mapping_trainable_ViT_frozen_5ROI_with_text_based_vision/train/saved_models/model_step_5016.ckpt",
