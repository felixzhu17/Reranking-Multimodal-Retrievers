...
local train_with_all = {
        ...
        'process:ConcatenateDatasets': {
          ...
          setup_kwargs: {
            ...
            concat_splits: {
              ...
              'valid': [true, false, false, false, true, false, false, true, true, false],
            },
        ...
        'process:ConcatenatePassageDatasets': {
          ...
          setup_kwargs: {
            ...
            concat_splits: {
              ...
              'filtered_passages': [true, false, false, false, true, false, false, true, true, false],
            },
          },
        },
    ...
    validation_indexing_source: ["wit_passages", "infoseek_passages", "okvqa_passages", "evqa_passages"],
