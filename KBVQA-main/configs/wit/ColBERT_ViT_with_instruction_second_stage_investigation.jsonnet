...
local train_with_all = {
      ...
      transforms: {
        'process:ConcatenateDatasets': {
          ...
          setup_kwargs: {
            ...
            concat_splits: {
              'train': [0.05, 0.05, 0.1, 0.1, 0.5, 0.1, 0.1, 10, true, true],
              'valid': [true, false, true, true, true, true, true, true, true, false],
            },
        ...
        'process:WrapOutputIntoKeys': {
          ...
          cache: false,
          setup_kwargs: {
            output_keys: ["wit_data", "cc_data", "llava_data", "msmarco_data", "infoseek_data", "oven_data", "kvqa_data", "okvqa_data", 'evqa_data', "combined_data"],
          },
        },
        'process:ConcatenatePassageDatasets': {
          ...
          cache: true,
          setup_kwargs: {
            names: ["wit_passages", "cc_passages", "llava_passages", "msmarco_passages", "infoseek_passages", "oven_passages", "kvqa_passages", 'okvqa_passages', 'evqa_passages', 'witq_passages'],
            concat_splits: {
              'passages': [true, true, true, true, true, true, true, true, true, true],
              'filtered_passages': [true, false, true, true, true, true, true, true, true, false],
            },
          },
        },
    ...
    validation_indexing_source: ["wit_passages", "msmarco_passages", "llava_passages", "kvqa_passages", "oven_passages", "infoseek_passages", "okvqa_passages", "evqa_passages"],
    monitor: 'valid/EVQADatasetForDPR.valid/loss',
};
...
local override = {
    ...
    executor: {
        ExecutorClass: 'ColBERTVisionLossInvestigationExecutor',
        init_kwargs: {
