...
local train_with_all = {
      ...
      transforms: {
        'process:ConcatenateDatasets': {
          ...
          setup_kwargs: {
            ...
            concat_splits: {
              'train': [0.15, 0.5, true, true, 0.5, true, true, 40, true, false, false, false],
              'valid': [true, false, true, true, true, true, true, true, true, true, true, true],
            },
        ...
        'process:ConcatenatePassageDatasets': {
          ...
          setup_kwargs: {
            ...
            concat_splits: {
              'passages': [true, true, true, true, true, true, true, true, true, false, false, false],
              'filtered_passages': [true, false, true, true, true, true, true, true, true, true, true, true],
            },
          },
        },
        'output:PrepareDataloaders': {
          setup_kwargs: {
            datasets_config: {
              ...
              test: [
                {
                  dataset_type: 'IGLUEDatasetForDPR',
                  split: 'valid',
                  use_column: 'iglue_data',
                },
                {
    ...
    validation_indexing_source: ['iglue_passages', 'mscoco_passages', 'flicker_passages', "msmarco_passages", "llava_passages", "kvqa_passages", "oven_passages", "infoseek_passages", "okvqa_passages", "evqa_passages"],
...
local data_loader_pipeline = {
  transforms: {
    ...
    'process:LoadMSMARCOData': {
      ...
      cache: true,
      setup_kwargs: {
        data_path: "/data/MSMARCO-400K/MSMARCO_training_with_instruction_sep.hf",
        passage_path: "/data/MSMARCO-400K/MSMARCO_passages_with_instruction_sep.hf",
    ...
    'process:LoadMSCOCOData': {
      ...
      cache: true,
      setup_kwargs: {
        data_path: "/home/ubuntu/data/MSCOCO/PrepareMSCOCOTest.hf",
        passage_path: "/home/ubuntu/data/MSCOCO/SplitMSCOCOTest.hf",
        add_instruction: [
