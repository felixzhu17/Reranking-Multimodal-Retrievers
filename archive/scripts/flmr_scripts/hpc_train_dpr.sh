...
options="--experiment_name \"OKVQA_WITCorpus(v2)_DPR_with_text_based_vision_mapping_trainable_multimodal_docs\" \
    --config \"configs/okvqa/wit/DPR.jsonnet\" \
