...
#! Name of the job:
#SBATCH -J OKVQA_VISUAL_COLBERT_TRAIN
...
options="--experiment_name \"OKVQA_WITCorpus(v2)(image_only)_VisualColBERT_with_pretrained_ViT(WIT)_5ROI_with_text_based_vision_use_last_ckpt\" \
    --config \"configs/okvqa/wit/ColBERT_vision_with_ROI.jsonnet\" \
    ...
    --opts train.trainer_paras.max_epochs=10000 \
             ...
             model_config.num_ROIs=4 \
             model_config.multimodal_docs=1 \
             train.load_model_path=\"/home/wl356/cvnlp_rds/wl356/projects/KBVQA/experiments/WIT_DPR_ViT_ColBERT/train/saved_models/last.ckpt\" \
             model_config.ModelClass=\"ColBERTWithMultimodalDocsOnlyImages\" \
