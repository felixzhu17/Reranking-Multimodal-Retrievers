...
options="--experiment_name \"OKVQA_RAG_ColBERT_with_text_based_vision_lr6e-5_10epoch\" \
    --config \"configs/rag/okvqa/RAG_colbert.jsonnet\" \
    ...
    --opts train.trainer_paras.max_epochs=10 \
             train.batch_size=2 \
             train.trainer_paras.val_check_interval=250 \
             valid.batch_size=16 \
