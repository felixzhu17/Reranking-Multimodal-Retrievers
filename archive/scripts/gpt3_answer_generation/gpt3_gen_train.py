...
PREDICTION_FILENAME = "/home/wl356/cvnlp_rds/wl356/projects/KBVQA/experiments/OKVQA_VisualColBERT_with_pretrained_ViT(WIT)_ColBERT_mapping_trainable_ViT_frozen_10ROI_with_text_based_vision/test/generate_index_train/generate_index_train_test_OKVQADatasetForDPR.train_predictions.json"
...
class RAVQAHelper():
    ...
    def get_question_and_annotation_by_id(self, question_id, with_knowledge=True, top_k_knowledge=5, with_answer=False):
        ...
        if self.prediction_lookup.get(id_, None) is None:
            return None
...
if __name__ == '__main__':
    ...
    f = open('scripts/gpt3_answer_generation/debug-okvqa_in_context_train_split_display.txt', 'w')

    # for question_id in QUESTION_IDS_TO_TEST:
    for question_id in tqdm([item['question_id'] for item in ravqa_helper.train_data['data_items']]):
