...
local index_files = {
  ...
  "static_results": [
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_train_index/test/generate_train_index/generate_train_index_test_InfoseekDatasetForDPR.train_predictions_rank_0.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_train_index/test/generate_train_index/generate_train_index_test_InfoseekDatasetForDPR.train_predictions_rank_1.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_train_index/test/generate_train_index/generate_train_index_test_InfoseekDatasetForDPR.train_predictions_rank_2.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_train_index/test/generate_train_index/generate_train_index_test_InfoseekDatasetForDPR.train_predictions_rank_3.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_test_index/test/generate_test_index/generate_test_index_test_InfoseekDatasetForDPR.valid_predictions_rank_0.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_test_index/test/generate_test_index/generate_test_index_test_InfoseekDatasetForDPR.valid_predictions_rank_1.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_test_index/test/generate_test_index/generate_test_index_test_InfoseekDatasetForDPR.valid_predictions_rank_2.pkl",
    "/data/project_data/experiments/AWS_Finetune_Infoseek_ViT(G)_NewFLMR(mask_instruct)_ColBERT(v2)_pretraining_ViT_frozen_lr=1e-5_mapping_lr=1e-5_load(4ymcu4na)_test_index/test/generate_test_index/generate_test_index_test_InfoseekDatasetForDPR.valid_predictions_rank_3.pkl",
  ],
};
// local index_files = {
  ...
  transforms: {
    ...
    'process:ConcatenatePassageDatasets': {
      ...
      setup_kwargs: {
        ...
        concat_splits: {
          'passages': [true, false, false],
          'filtered_passages': [true, false, false],
        },
      },
    },
...

{
    ...
    train: {
        ...
        model_checkpoint_callback_paras: {
            monitor: 'valid/InfoseekDataset.valid/accuracy',
            save_top_k: 1,
            mode: "max",
