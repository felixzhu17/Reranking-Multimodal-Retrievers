...
torchrun --nproc_per_node={gpus} src/main.py --config {config_file} --mode train --experiment_name {experiment_name} --reset --override --tags {tags_str} {opts_str} > log_{experiment_name} 2>&1
"""
