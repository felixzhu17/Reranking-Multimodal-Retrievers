...
job_template = """
python src/main.py --config {config_file} --mode test --experiment_name TESTDEBUGDUMMY --reset --override {opts_str}
"""
...
def main(config_name):
    ...
    for config in configs:
        ...
        opts_str = "--opts test.trainer_paras.limit_test_batches=1 test.trainer_paras.max_epochs=1 test.batch_size=3"
