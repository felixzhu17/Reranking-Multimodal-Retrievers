        ...
        def _get_tokenizer(tokenizer_config):
            ...
            if TokenizerClass == QueryTokenizer or TokenizerClass == DocTokenizer:
                ...
                if TokenizerClass == FLMRContextEncoderTokenizer:
                    tokenizer = FLMRContextEncoderTokenizer.from_pretrained(tokenizer_config.TokenizerModelVersion, subfolder="context_tokenizer", trust_remote_code=True)
                elif TokenizerClass == FLMRQueryEncoderTokenizer:
                    tokenizer = FLMRQueryEncoderTokenizer.from_pretrained(tokenizer_config.TokenizerModelVersion, subfolder="query_tokenizer", trust_remote_code=True)
                else:
                    tokenizer = TokenizerClass.from_pretrained(tokenizer_config.TokenizerModelVersion, trust_remote_code=True)
